...
document.addEventListener("turbolinks:load", function() {  
    var momentTH = moment.defineLocale('th', {
  ...
  $('.converTime').each(function() {
    this.textContent = moment(moment(this.textContent).locale('th', momentTH)).format('ll')
  });

  $("tr[data-link]").click(function() {
    let value = $(this).data('link')
    let cutValue = value.split('##')

    let bill_amount = cutValue[0]
    let bill_id = cutValue[1]
